...
/**
 * Add a file path to fuse
 *
 * This calls fuse_lowlevel_notify_file_create internally.
 *
 * @return 0 on successful operation, negative error value otherwise.
 */
int fuse_add_path(struct fuse *f, const char *parent_path, const char *name);
